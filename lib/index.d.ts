...
export declare const generateVideoThumbnails: (videoFile: File, numberOfThumbnails: number, type: string, cb?: (thumbnail: string, index: number) => void) => Promise<string[]>;
