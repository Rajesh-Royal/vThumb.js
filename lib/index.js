...
const generateVideoThumbnails = async (videoFile, numberOfThumbnails, type, cb) => {
    let thumbnail = [];
    let fractions = [];
    return new Promise(async (resolve, reject) => {
        ...
        await (0, exports.getVideoDurationFromVideoFile)(videoFile).then(async (duration) => {
...
const getVideoCover = (urlOfFIle, seekTo = 0.0) => {
    return new Promise((resolve, reject) => {
        try {
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            var snapImage = function () {
                ...
                var success = (image === null || image === void 0 ? void 0 : image.length) > 100000;
                if (success) {
